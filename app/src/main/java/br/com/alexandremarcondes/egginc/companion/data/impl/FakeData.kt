...
val deviceInfo1: Ei.DeviceInfo = Ei.DeviceInfo.newBuilder()
    .setDeviceId("55db18283aca1")
    .setDeviceName("alex1_device")
    .build()

val deviceInfo2: Ei.DeviceInfo = Ei.DeviceInfo.newBuilder()
    .setDeviceId("55db18283aca2")
    .setDeviceName("alex2_device")
    .build()

val deviceInfo3: Ei.DeviceInfo = Ei.DeviceInfo.newBuilder()
    .setDeviceId("55db18283aca3")
    .setDeviceName("alex3_device")
    .build()

val deviceInfo4: Ei.DeviceInfo = Ei.DeviceInfo.newBuilder()
    .setDeviceId("55db18283aca4")
    .setDeviceName("alex4_device")
    .build()

val deviceInfo5: Ei.DeviceInfo = Ei.DeviceInfo.newBuilder()
